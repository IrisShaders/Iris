...
* BSL and Complementary shaders, Sildur's Vibrant Shaders, and XorDev's shaderpacks work for the most part under Iris, and have been the focus of my development. However, most other shaderpacks either have severe rendering issues, or do not work at all. My current focus is to get Sildur's Vibrant Shaders and XorDev's shaderpacks to the point where they are 100% working before shifting focus to other shaderpacks. As I fix issues in these shaderpacks, other shaderpacks will very likely begin to work properly as well.
* Shadows are currently not implemented in the main Iris repository, but I have been working on a shadows branch in a private fork. However, this implementation of shadow mapping is currently extremely experimental, considerably unstable, and hardly optimized at all. I am not comfortable merging this code into main mainstream Iris, and much more work will need to be done before the code has been sufficiently polished. That being said, there is an experimental shadows build available on [my Patreon page](https://www.patreon.com/coderbot) for those who would like early-access to this experimental feature.
