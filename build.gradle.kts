...
val SODIUM_DEPENDENCY_FABRIC by extra { "net.caffeinemc:sodium-fabric:0.6.7-snapshot+mc1.21.4-local" }
val SODIUM_DEPENDENCY_NEO by extra { "net.caffeinemc:sodium-neoforge:0.6.7-snapshot+mc1.21.4-local" }
