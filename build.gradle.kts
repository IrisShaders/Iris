...
val MINECRAFT_VERSION by extra { "26.3-rc-2" }
...
val SODIUM_DEPENDENCY_FABRIC by extra { "net.caffeinemc:sodium-fabric:0.9.2-beta.2+mc26.3r1" }
val SODIUM_DEPENDENCY_NEO by extra { "net.caffeinemc:sodium-fabric:0.9.2-beta.2+mc26.3r1" }
