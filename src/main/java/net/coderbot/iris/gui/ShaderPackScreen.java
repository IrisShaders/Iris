...
public class ShaderPackScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("pack.available.title").formatted(Formatting.GRAY, Formatting.ITALIC), (int)(this.width * 0.25), 18, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("pack.selected.title").formatted(Formatting.GRAY, Formatting.ITALIC), (int)(this.width * 0.75), 18, 16777215);
