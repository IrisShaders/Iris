...
public class CompositeRenderer {
	...
	public CompositeRenderer(PackDirectives packDirectives, ProgramSource[] sources, RenderTargets renderTargets, ShaderStorageBufferHolder shaderStorageBufferHolder,
