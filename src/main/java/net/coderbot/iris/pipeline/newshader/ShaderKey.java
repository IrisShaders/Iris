...
public enum ShaderKey {
	...
	PARTICLES              (ProgramId.Particles,   AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLES,                     FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	PARTICLES_TRANS        (ProgramId.ParticlesTrans,AlphaTests.ONE_TENTH_ALPHA,IrisVertexFormats.PARTICLES,                    FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	WEATHER                (ProgramId.Weather,     AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLES,                     FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	...
	SHADOW_PARTICLES       (ProgramId.Shadow,      AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLES,	     			    FogMode.OFF,          LightingModel.LIGHTMAP  ),
