...
public enum ShaderKey {
	...
	TEXT                   (ProgramId.BlockTrans,  AlphaTests.ONE_TENTH_ALPHA,IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_INTENSITY         (ProgramId.BlockTrans,  AlphaTests.ONE_TENTH_ALPHA,IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
