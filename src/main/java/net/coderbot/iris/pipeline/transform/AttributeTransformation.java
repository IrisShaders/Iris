...
class AttributeTransformation extends Transformation<Parameters> {
	...
	static LifecycleUser<Parameters> replaceEntityColorDeclaration = new Transformation<Parameters>() {
		@Override
		protected void setupGraph() {
	...
	static LifecycleUser<Parameters> wrapOverlay = new MainWrapper<Parameters>() {
		@Override
	...
	static LifecycleUser<Parameters> renameEntityColorFragment = new SearchTerminals<Parameters>() {
		@Override
