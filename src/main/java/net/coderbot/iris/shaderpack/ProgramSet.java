...
public class ProgramSet {
	...
	private final ProgramSource gbuffersText;
	...
	public ProgramSet(AbsolutePackPath directory, Function<AbsolutePackPath, String> sourceProvider,
		...
		this.gbuffersText = readProgramSource(directory, sourceProvider, "gbuffers_text", this, shaderProperties);
	...
	private void locateDirectives() {
		...
		programs.addAll (Arrays.asList(
				...
				gbuffersEntities, gbuffersText, gbuffersEntitiesGlowing, gbuffersGlint, gbuffersEntityEyes, gbuffersBlock,
				gbuffersHand
		));
	...
	public Optional<ProgramSource> getGbuffersText() {
		return gbuffersText.requireValid();
	}
	...
	public Optional<ProgramSource> get(ProgramId programId) {
		switch (programId) {
			...
			case Text: return getGbuffersText();
