...
public class IrisVertexFormats {
	...
	static {
		...
		ENTITY_ID_ELEMENT = new VertexFormatElement(11, VertexFormatElement.Type.USHORT, VertexFormatElement.Usage.GENERIC, 2);
		...
		entityElements.add(ENTITY_ID_ELEMENT); // 40 (unsigned)
