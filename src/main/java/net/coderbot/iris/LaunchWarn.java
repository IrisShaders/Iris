...
public class LaunchWarn {
	public static void main(String[] args) {
		...
		String fallback = "This file is the Fabric version of Iris, meant to be installed as a mod. Please download the Iris Installer.";
		if (GraphicsEnvironment.isHeadless()) {
			...
			if (Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
				int option = JOptionPane.showOptionDialog(null, message, "Iris Installer", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, null, null);
