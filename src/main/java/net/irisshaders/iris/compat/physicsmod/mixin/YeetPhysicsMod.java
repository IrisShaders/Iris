package net.irisshaders.iris.compat.physicsmod.mixin;
...
public class YeetPhysicsMod implements IMixinConfigPlugin {
	...
	public void postApply(String targetClassName, ClassNode targetClass, String mixinClassName, IMixinInfo mixinInfo) {
		...
		redirect(found, renderType, setupRenderState, "()V", "net/irisshaders/iris/compat/physicsmod/PhysicsModHooks", "redirectSetupRenderState", "(L" + renderType + ";)V");
		redirect(found, renderType, clearRenderState, "()V", "net/irisshaders/iris/compat/physicsmod/PhysicsModHooks", "redirectClearRenderState", "(L" + renderType + ";)V");
		redirect(found, renderType, solid, "()L" + renderType + ";", "net/irisshaders/iris/compat/physicsmod/PhysicsModHooks", "getTargetRenderType", "()L" + renderType + ";");
	}
