...
import net.irisshaders.iris.shaderpack.transform.BuiltinUniformReplacementTransformer;
import net.irisshaders.iris.shaderpack.transform.StringTransformations;
import net.irisshaders.iris.shaderpack.transform.Transformations;
import net.irisshaders.iris.uniforms.CommonUniforms;
import net.irisshaders.iris.uniforms.SamplerUniforms;
