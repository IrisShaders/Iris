...
import net.irisshaders.iris.vendored.joml.Math;
import net.irisshaders.iris.vendored.joml.Vector3f;
...
public abstract class NormalHelper {
	...
	public static void computeFaceNormal(@NotNull Vector3f saveTo, QuadView q) {
		...
		float l = (float) java.lang.Math.sqrt(normX * normX + normY * normY + normZ * normZ);
