...
public interface LocationalUniformHolder extends UniformHolder {
	...
	@Override
	default LocationalUniformHolder uniformJomlMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<net.irisshaders.iris.vendored.joml.Matrix4f> value) {
