...
public class CubePositions {
	public final float[] currentX = new float[8];
	public final float[] currentY = new float[8];
	public final float[] currentZ = new float[8];

	public final float[] velocityX = new float[8];
	public final float[] velocityY = new float[8];
	public final float[] velocityZ = new float[8];

	public int[] lastFrameUpdate = new int[8];
